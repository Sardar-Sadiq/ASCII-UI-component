...
import CyberHack from "@/components/cyberhack";
...
const CYBER_HACK_CODE_TSX = `"use client";
...
const CYBER_HACK_CODE_JSX = `"use client";
...
const CYBER_CORE_CODE_TSX = `"use client";
...
const CYBER_CORE_CODE_JSX = CYBER_CORE_CODE_TSX;
...
export const COMPONENTS: ComponentMetadata[] = [
    ...
    },
    {
        ...
        name: "Cyber Hack",
        version: "1.0.0",
        description: "A glitchy, layered cybersecurity-themed ASCII animation.",
        component: CyberHack,
        code: CYBER_HACK_CODE_TSX,
        codeJsx: CYBER_HACK_CODE_JSX
    },
    {
        id: "cyber-core",
        name: "Cyber Core",
        version: "1.0.0",
        description: "A central processing core visualization with rotating rings and data feeds.",
        component: CyberCore,
        code: CYBER_CORE_CODE_TSX,
        codeJsx: CYBER_CORE_CODE_JSX
    },
    {
        id: "cyber-transition",
